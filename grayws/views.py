...
def default_stacks():
    ...
    return redirect(f"/stacks/{region}/")

@app.route("/stacks/<region>/")
def stacks(region):
    print(region)
...
@app.route("/stack/<region>/<stack_name>/")
...
@app.route("/stack/<region>/<stack_name>/graph/")
...
@app.route("/stack/<region>/<stack_name>/set/<changeset>/")
...
@app.route("/stack/<region>/<stack_name>/set/<changeset>/apply")
...
@app.route("/stack/<region>/<stack_name>/set/<changeset>/delete")
...
@app.route("/stack/<region>/<stack_name>/events")
